# Имя файла: handlers/__init__.py (ВРЕМЕННАЯ ОТЛАДОЧНАЯ ВЕРСИЯ 2)

from .start_handler import router as start_router
from .common_handler import router as common_router
from .order_handler import router as order_router # <-- РАСКОММЕНТИРОВАТЬ
...
# Добавляем order_router в экспорт
__all__ = [
    "start_router",
    "common_router",
    "order_router", # <-- РАСКОММЕНТИРОВАТЬ
]